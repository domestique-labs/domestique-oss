...
from `~/.domestique/ca/domestique-ca.{pem,key}` exactly once
...
from domestique_app.services.proxy import _refresh_mitm_confdir
...
class TestRefreshMitmConfdir:
    def test_copies_when_confdir_missing(self, tmp_path):
        ca_cert = tmp_path / "domestique-ca.pem"
        ca_key = tmp_path / "domestique-ca.key"
