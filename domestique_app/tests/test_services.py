...
from domestique_app.services.proxy import ProxyService, ProxyState
...
class TestProxyService:
    ...
    def test_build_env_qwen3(self, mock_popen):
        ...
        assert env["DOMESTIQUE_LOCAL_LLM_MODEL"] == "qwen3:1.7b"
        assert env["DOMESTIQUE_ENABLE_LOCAL_LLM"] == "true"
    ...
    def test_build_env_gemma4(self, mock_popen):
        ...
        env = mock_popen.call_args[1]["env"]
        assert env["DOMESTIQUE_LOCAL_LLM_MODEL"].startswith("gemma4:e2b")
    ...
    def test_build_env_no_llm(self, mock_popen):
        ...
        env = mock_popen.call_args[1]["env"]
        assert env["DOMESTIQUE_ENABLE_LOCAL_LLM"] == "false"
    ...
    def test_build_env_legacy_cpu(self, mock_popen):
        ...
        env = mock_popen.call_args[1]["env"]
        assert env["DOMESTIQUE_LOCAL_LLM_MODEL"] == "llama3.2:1b"
        assert env["DOMESTIQUE_ENABLE_LOCAL_LLM"] == "true"
