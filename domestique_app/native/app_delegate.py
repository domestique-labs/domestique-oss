...
from domestique_app.config.store import ConfigStore  # noqa: E402
from domestique_app.native.status_bar import StatusBar  # noqa: E402
from domestique_app.services.benchmark import BenchmarkService  # noqa: E402
from domestique_app.services.proxy import ProxyService  # noqa: E402
from domestique_app.services.watchdog import ProtectionState, Watchdog  # noqa: E402
...
class AppDelegate(NSObject):
    ...
    def _ensure_cert_trusted(self) -> None:
        ...
        try:
            ...
            from domestique_app.services.cert_manager import install_and_trust, is_cert_trusted
    ...
    def _start_protection(self) -> None:
        ...
        try:
            ...
            try:
                from domestique_app.server.api import _venv_scanner
            ...
            try:
                import domestique_app.server.api as _api2
