...
class TestClearPortDispatch:
    ...
    def test_windows_uses_taskkill_not_lsof(self):
        ...
        with patch("app.services.proxy.is_port_listening", return_value=True), \
             patch("app.services.proxy.is_windows", return_value=True), \
    ...
    def test_linux_uses_lsof_not_taskkill(self):
        ...
        svc = BrowserProxyService()
        with patch("app.services.proxy.is_port_listening", return_value=True), \
             patch("app.services.proxy.is_windows", return_value=False), \
    ...
    def test_no_action_when_port_free(self):
        ...
        svc = BrowserProxyService()
        with patch("app.services.proxy.is_port_listening", return_value=False), \
             patch("subprocess.run") as mock_run:
            svc._clear_port()
...
class TestRuntimeHelpers:
    ...
    def test_subprocess_group_kwargs_returns_dict(self):
        from app.services.runtime import subprocess_group_kwargs
    ...
    def test_venv_python_finds_correct_binary(self, tmp_path: Path):
        ...
        from app.services.runtime import venv_python
    ...
    def test_is_port_listening_false_for_unbound_port(self):
        from app.services.runtime import is_port_listening
...
class TestProxyRestart:
    ...
    def test_restart_with_nothing_running(self):
        ...
        from app.server.api import _proxy_service, _browser_proxy_service
...
class TestResourceMonitor:
    ...
    def test_snapshot_returns_nonzero_memory(self):
        ...
        from app.server.api import _ResourceMonitor
