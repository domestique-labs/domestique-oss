...
class TestWatchdogHealthChecks:
    ...
    @patch("app.services.watchdog.is_port_listening")
...
class TestNetworkChangeDetection:
    ...
    @patch("app.services.watchdog.Watchdog._get_active_interfaces")
    @patch("app.services.watchdog.Watchdog._reapply_pac")
