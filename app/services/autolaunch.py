...
Usage:
    from app.services.autolaunch import AutoLaunchManager
...
class AutoLaunchManager:
        ...
        plist = {
            ...
            "ProgramArguments": [
                ...
                (
                    ...
                    "from app.main import launch; launch()"
                ),
            ],
            "RunAtLoad": True,
            "KeepAlive": {
    ...
    def _is_windows_run_key_enabled(self) -> bool:
        ...
        try:
            ...
            return "app.main" in value or "from app.main import launch" in value
...
python3 -c "
from app.services.interceptor import generate_ca, install_ca_to_keychain
